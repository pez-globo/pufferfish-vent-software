...
def test_invalid_ventilating(
    ...
    # Then: alarms are not updated for parameters
    assert test_service._manager.active_alarm_ids.get(pb.LogEventCode.spo2_too_low) is None
...
def test_pcac_alarm_min(
    ...
    assert test_service._manager.active_alarm_ids.get(pb.LogEventCode.spo2_too_low) is not None
    assert test_service._manager.active_alarm_ids.get(pb.LogEventCode.fio2_too_low) is not None
...
def test_pcac_alarm_max(
    ...
    assert test_service._manager.active_alarm_ids.get(pb.LogEventCode.spo2_too_low) is None
    assert test_service._manager.active_alarm_ids.get(pb.LogEventCode.fio2_too_high) is not None
    assert test_service._manager.active_alarm_ids.get(pb.LogEventCode.spo2_too_high) is not None
